...
public:
    ...
    [[nodiscard]] static Result<std::shared_ptr<Package>, std::string> OpenFromCompressed(const std::filesystem::path& pack, const std::filesystem::path& targetDir, unsigned long ID);
